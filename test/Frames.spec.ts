...
describe('Frames', function() {
    it('rotateJ2000Mod', function() {
        ...
        assert.equal(osvMod_1.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvMod_2.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvMod_3.frameCenter, FrameCenter.BODY_CENTER);
    ...
    it('rotateModJ2000', function() {
        ...
        assert.equal(osvJ2000_1.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvJ2000_2.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvJ2000_3.frameCenter, FrameCenter.BODY_CENTER);
    ...
    it('rotateModTod', function() {
        ...
        assert.equal(osvTod_1.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvTod_2.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvTod_3.frameCenter, FrameCenter.BODY_CENTER);
    ...
    it('rotateTodPef', function() {
        ...
        assert.equal(osvPef_1.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvPef_2.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvPef_3.frameCenter, FrameCenter.BODY_CENTER);
    ...
    it('rotatePefEfi', function() {
        ...
        assert.equal(osvEfi_1.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvEfi_2.frameCenter, FrameCenter.BODY_CENTER);
        ...
        assert.equal(osvEfi_3.frameCenter, FrameCenter.BODY_CENTER);
    ...
    it('rotateEfiEnu', function() {
        ...
        assert.equal(osvEnuHor.frameCenter, FrameCenter.PLANET_TOPO);
    ...
    it('rotateEnuEfi', function() {
        ...
        assert.equal(osvEfiGeo.frameCenter, FrameCenter.BODY_CENTER);
